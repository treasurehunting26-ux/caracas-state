      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#fafaf7">
        ...
        <tr><td style="padding:40px 48px 24px">
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto"><tr><td align="center">
            <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${downloadUrl}" style="height:50px;v-text-anchor:middle;width:240px;" arcsize="0%" stroke="f" fillcolor="#c9a84c"><w:anchorlock/><center style="color:#0a0a0a;font-family:Arial,sans-serif;font-size:11px;font-weight:bold;letter-spacing:2.5px;">ACCESS THE DOSSIER</center></v:roundrect><![endif]-->
            <!--[if !mso]><!-- --><a href="${downloadUrl}" target="_blank" style="background-color:#c9a84c;background:#c9a84c;color:#0a0a0a;display:inline-block;font-family:'Helvetica Neue',Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:2.5px;line-height:50px;text-align:center;text-decoration:none;text-transform:uppercase;width:240px;-webkit-text-size-adjust:none;mso-hide:all">Access the Dossier</a><!--<![endif]-->
          </td></tr></table>
